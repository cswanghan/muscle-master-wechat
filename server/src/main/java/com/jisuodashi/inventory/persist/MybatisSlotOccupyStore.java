...
public class MybatisSlotOccupyStore implements SlotOccupyStore {
    ...
    public List<BookingOrderRef> listOrdersByCustomer(long customerId) {
        List<BookingOrderRef> rows = mapper.listOrdersByCustomer(customerId);
    ...
    public List<BookingOrderRef> listOrdersByCustomerId(long customerId) {
        return mapper.listOrdersByCustomerId(customerId);
    }
    ...
    @Override
    public List<SlotRow> lockTherapistSlots(long therapistId, LocalDate date, List<Integer> slotNos) {
        return mapper.lockTherapistSlots(therapistId, date, csv(slotNos));
    }
